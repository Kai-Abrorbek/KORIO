export default {
  ...
  recipe: {
    readyCount: "Готово {{ready}}/{{total}} типов",
    cardMeta: "Ключевых пунктов: {{grammar}} · Заданий: {{practice}}",
    comingSoon: "В подготовке",
    answerIs: "Правильный ответ: {{mark}}",
    level: "{{level}} уровень",
    golden: "Золотой рецепт",
    grammar: "Ключевой рейтинг",
    grammarCount: "{{count}} ключевых пунктов",
    grammarSubtitle: "По вероятности и важности",
    pastQuestions: "Разобранные примеры",
    showSolution: "Смотреть разбор",
    solution: "Разбор",
    questionNo: "Задание {{number}}",
    practice: "Пробные задания",
    practiceCount: "{{count}} заданий",
    submit: "Проверить",
    resultTitle: "Верных ответов",
    backToRecipe: "Вернуться к уроку",
    listenAudio: "Прослушать диалог",
    stopAudio: "Остановить",
    sampleAnswer: "Образец ответа",
    noSampleAnswer: "Образец ответа отсутствует.",
    writingResultTitle: "Выполненные письменные задания",
    writingPlaceholder: "Введите ответ.",
    minimumCharacters: "Напишите не менее {{count}} знаков.",
  },
};
