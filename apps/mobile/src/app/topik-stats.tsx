...
const styles = StyleSheet.create({
  ...
  stateText: { color: "#717983", fontSize: 14 },
  errorTitle: { color: "#424A54", fontSize: 17, fontWeight: "800" },
  ...
  heroLabel: { color: "#D5E0EA", fontSize: 13, fontWeight: "700" },
  accuracy: { color: "#FFFFFF", fontSize: 48, lineHeight: 58, fontWeight: "900" },
  ...
  ringValue: { color: "#FFFFFF", fontSize: 21, fontWeight: "900" },
  ...
  quickValue: { color: "#2D333B", fontSize: 20, fontWeight: "900" },
  ...
  sectionTitle: { color: "#292E35", fontSize: 19, fontWeight: "900" },
  ...
  typeName: { color: "#363C44", fontSize: 13, fontWeight: "800" },
  typeAccuracy: { color: "#173B67", fontSize: 13, fontWeight: "900" },
  ...
  weakNumberText: { color: "#B94646", fontSize: 14, fontWeight: "900" },
  weakInfo: { flex: 1, gap: 2 },
  weakTitle: { color: "#363B42", fontSize: 13, fontWeight: "800" },
  weakMeta: { color: "#858A91", fontSize: 10 },
  weakAccuracy: { color: "#B94646", fontSize: 13, fontWeight: "900" },
  ...
  historyMode: { color: "#343A42", fontSize: 13, fontWeight: "900" },
  historyDate: { color: "#8B9097", fontSize: 10, marginTop: 3 },
  historyScoreWrap: { alignItems: "flex-end", gap: 2 },
  historyScore: { color: "#173B67", fontSize: 16, fontWeight: "900" },
