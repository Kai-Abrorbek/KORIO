...
const styles = StyleSheet.create({
  ...
  loadingText: { color: "#67717C", fontSize: 14 },
  errorTitle: { color: "#3D4650", fontSize: 17, fontWeight: "800" },
  ...
  heroTitle: { color: "#FFFFFF", fontSize: 19, fontWeight: "900", marginTop: 5 },
  score: { color: "#FFFFFF", fontSize: 62, lineHeight: 70, fontWeight: "900", marginTop: 9 },
  scoreUnit: { color: "#C4D4E3", fontSize: 13, fontWeight: "700" },
  ...
  summaryValue: { color: "#FFFFFF", fontSize: 15, fontWeight: "900", textAlign: "center" },
  summaryLabel: { color: "#AFC4D8", fontSize: 10 },
  summaryDivider: { width: 1, height: 29, backgroundColor: "#FFFFFF26" },
  reviewHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  sectionTitle: { color: "#272C33", fontSize: 20, fontWeight: "900" },
  sectionCaption: { color: "#777D85", fontSize: 11, marginTop: 4 },
  ...
  answerLine: { color: "#343A42", fontSize: 14, fontWeight: "800" },
  correctLine: { color: "#737A83", fontSize: 12 },
  ...
  explanationText: { color: "#4E555E", fontSize: 13, lineHeight: 20 },
  ...
  statsButtonText: { color: "#173B67", fontSize: 15, fontWeight: "900" },
