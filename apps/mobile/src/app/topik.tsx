  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t("topik.home.header", { level: roman })}</Text>
        <Pressable
      ...
      >
        <View style={styles.hero}>
          ...
          <View style={styles.heroMetrics}>
            <View>
              ...
              <Text style={styles.metricLabel}>{t("topik.common.questions")}</Text>
            </View>
            ...
            <View>
              ...
              <Text style={styles.metricLabel}>{t("topik.common.minutes")}</Text>
            </View>
            <View style={styles.metricDivider} />
            <View>
              <Text style={styles.metricValue}>
        ...
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>{t("topik.home.examSelection")}</Text>
          <Text style={styles.sectionCaption}>{t("topik.home.readingTest")}</Text>
        </View>
        ...
        {loading ? (
          ...
          <View style={styles.stateCard}>
            <Ionicons name="documents-outline" size={29} color={palette.textMuted} />
        ...
        <View style={styles.modeList}>
          {MODES.map((item) => {
            ...
            const color = item.key === "guided" ? palette.warning : palette.primary;
            return (
              <Pressable
                key={item.key}
              ...
              >
                <View
                  style={[
                    styles.modeIcon,
                    { backgroundColor: palette.isDark ? palette.surfaceMuted : `${color}18` },
                  ]}
                >
                ...
                <View style={styles.modeInfo}>
                  ...
                  <Text style={styles.modeDescription}>{t(item.descriptionKey)}</Text>
                </View>
...
const getStyles = (palette: TopikPalette) => StyleSheet.create({
  ...
  metricDivider: { width: 1, height: 29, backgroundColor: palette.heroDividerStrong },
  sectionHeader: {
    flexDirection: "row",
    alignItems: "baseline",
    justifyContent: "space-between",
  ...
  examCardSelected: { borderColor: palette.primary, backgroundColor: palette.primarySoft },
  examNumber: {
    width: 44,
    height: 50,
    alignItems: "center",
  ...
  modeCardSelected: { borderColor: palette.primary, backgroundColor: palette.primarySoft },
  modeIcon: {
    width: 48,
    height: 48,
    borderRadius: 14,
  ...
  modeDescription: { color: palette.textSecondary, fontSize: 11, lineHeight: 17 },
  radio: {
    width: 21,
    height: 21,
    borderWidth: 2,
  ...
  stateText: { color: palette.textSecondary, fontSize: 11, textAlign: "center" },
  retryButton: {
    borderRadius: 9,
    backgroundColor: palette.primaryStrong,
