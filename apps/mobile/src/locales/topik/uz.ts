export default {
  ...
  recipe: {
    readyCount: "{{ready}}/{{total}} tur tayyor",
    cardMeta: "{{grammar}} ta asosiy nuqta · {{practice}} ta savol",
    comingSoon: "Tayyorlanmoqda",
    answerIs: "To'g'ri javob: {{mark}}",
    level: "{{level}}-daraja",
    golden: "Oltin retsept",
    grammar: "Asosiy reyting",
    grammarCount: "{{count}} ta asosiy nuqta",
    grammarSubtitle: "Chiqish ehtimoli va muhimligi bo'yicha",
    pastQuestions: "Yechilgan namunalar",
    showSolution: "Izohni ko'rish",
    solution: "Izoh",
    questionNo: "{{number}}-savol",
    practice: "Taxminiy savollarni yechish",
    practiceCount: "{{count}} ta savol",
    submit: "Tekshirish",
    resultTitle: "To'g'ri javoblar",
    backToRecipe: "Darsga qaytish",
    listenAudio: "Dialogni tinglash",
    stopAudio: "Tinglashni to'xtatish",
    sampleAnswer: "Namunaviy javob",
    noSampleAnswer: "Namunaviy javob mavjud emas.",
    writingResultTitle: "Yozib tugatilgan savollar",
    writingPlaceholder: "Javobingizni yozing.",
    minimumCharacters: "Kamida {{count}} ta belgi yozing.",
  },
};
