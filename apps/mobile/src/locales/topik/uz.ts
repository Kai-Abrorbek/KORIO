export default {
  ...
  recipe: {
    ...
    cardMeta: "Grammatika {{grammar}} · Savol {{practice}}",
    comingSoon: "Tayyorlanmoqda",
    answerIs: "To'g'ri javob: {{mark}}",
    level: "{{level}}-daraja",
    golden: "Oltin retsept",
    grammar: "TOPIKda ko'p uchraydigan grammatika",
    grammarCount: "{{count}} ta",
    grammarSubtitle: "Chiqish chastotasi bo'yicha",
    pastQuestions: "Oldingi savollar",
