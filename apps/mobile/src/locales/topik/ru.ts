export default {
  ...
  recipe: {
    ...
    cardMeta: "Грамматика {{grammar}} · Заданий {{practice}}",
    comingSoon: "В подготовке",
    answerIs: "Правильный ответ: {{mark}}",
    level: "{{level}} уровень",
    golden: "Золотой рецепт",
    grammar: "Часто встречающаяся грамматика",
    grammarCount: "{{count}} шт.",
    grammarSubtitle: "По частоте",
    pastQuestions: "Задания прошлых лет",
