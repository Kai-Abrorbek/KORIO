export default {
  ...
  recipe: {
    ...
    cardMeta: "{{grammar}} key points · {{practice}} questions",
    comingSoon: "Coming soon",
    answerIs: "Answer: {{mark}}",
    level: "Level {{level}}",
    golden: "Golden Recipe",
    grammar: "Key Ranking",
    grammarCount: "{{count}} key points",
    grammarSubtitle: "By test probability and importance",
    pastQuestions: "Worked examples",
    ...
    listenAudio: "Play dialogue",
    stopAudio: "Stop audio",
    sampleAnswer: "Sample answer",
    noSampleAnswer: "No sample answer is available.",
    writingResultTitle: "Completed responses",
    writingPlaceholder: "Write your answer.",
    minimumCharacters: "Write at least {{count}} characters.",
  },
};
