...
export default {
  ...
  lesson: {
    ...
    speaking: {
      ...
      notSupportedHere: "이 환경에서는 마이크를 쓸 수 없어요. 앱에서 이용해주세요",
  ...
  studyPath: {
    lessonProgress: "레슨 {{done}}/{{total}}",
    continueLesson: "{{n}}번째 레슨 시작",
    title: "학습 로드",
    dayLabel: "{{n}}일차",
    dayWithTitle: "{{n}}일차 · {{title}}",
    ...
    desc: {
      review: "지난 시간에 배운 걸 먼저 되짚어요.",
      words: "오늘 배울 단어를 카드로 익혀요.",
      grammar: "오늘 배울 문법 규칙을 익혀요.",
      vocabQuiz1: "오늘 단어를 문제로 확인해요.",
      vocabQuiz2: "남은 어휘 문제를 마저 풀어요.",
      grammarQuiz: "오늘 문법을 문제로 확인해요.",
      final: "틀렸던 것부터 다시 보고 하루를 마쳐요.",
    },
  },
};
