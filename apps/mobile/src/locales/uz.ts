...
export default {
  ...
  expressionRoadmap: {
    ...
    heroDescription: "Har bir iborani uch marta ko'rsangiz, keyingi tugun ochiladi.",
  ...
  expressionLearning: {
    ...
    doneDescription: "‘{{node}}’ bo'yicha {{count}} ta iborani ko'rib chiqdingiz.",
  ...
  studyModeModal: {
    ...
    subtitle: "{{course}} o'rganishni boshlaymiz. Keyin istalgan payt o'zgartirasiz.",
  ...
  studyPath: {
    lessonProgress: "Dars {{done}}/{{total}}",
    continueLesson: "{{n}}-darsni boshlash",
    title: "O'quv yo'li",
    dayLabel: "{{n}}-kun",
    dayWithTitle: "{{n}}-kun · {{title}}",
    ...
    node: {
      ...
      vocabQuiz1: "Leksika mashqi ①",
      vocabQuiz2: "Leksika mashqi ②",
    ...
    desc: {
      ...
      vocabQuiz1: "Bugungi so'zlarni mashqda sinab ko'ring.",
      vocabQuiz2: "Qolgan leksika mashqlarini tugating.",
      grammarQuiz: "Bugungi grammatikani mashqda sinab ko'ring.",
      final: "Xato qilganlaringizni ko'rib, kunni yakunlang.",
    },
  },
};
