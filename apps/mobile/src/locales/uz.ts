...
export default {
  ...
  rank: {
    bannerTitle: "Men nechanchi o'rindaman?",
    bannerSub: "Barcha o'quvchilar orasidagi o'rningizni ko'ring",
    prefix: "",
    suffix: "-o'rin",
    topPercent: "Eng yaxshi {{p}}%",
    ofTotal: "{{total}} ta o'quvchi orasida",
    tier: {
      legend: "Afsona",
      master: "Ustoz",
      elite: "Yuqori safda",
    ...
    xpValue: "{{xp}} XP",
    dayValue: "{{days}} kun",
    nextRank: "Bir pog'ona ko'tarilish uchun {{xp}} XP",
    nextRankMaxed: "Bundan yuqorisini daraja va izchillik hal qiladi",
    first: "Umumiy 1-o'rin. Yuqorida hech kim yo'q",
    unranked: {
      title: "Hozircha o'rningiz yo'q",
      desc: "Bitta darsni tugatsangiz, {{total}} kishi orasida o'rningiz belgilanadi.",
    },
    error: "O'rinni yuklab bo'lmadi · {{code}}",
  },
  tour: {
    next: "Keyingi",
    done: "Boshlash",
    ...
    home: {
      ...
      rank: {
        title: "O'rningizni ko'ring",
        desc: "Barcha o'quvchilar orasida nechanchi ekaningizni bosib ko'ring. O'rin tez o'zgaradi, shuning uchun natija 1 daqiqa turadi.",
      },
      categories: {
  ...
  auth: {
    ...
    verify: {
      ...
      resendIn: "{{count}} soniyadan keyin qayta yuborish mumkin",
    ...
    reset: {
      ...
      cta: "Parolni o'zgartirish",
      mismatch: "Parollar mos kelmadi",
      tooShort: "Kamida 6 ta belgi bo'lsin",
      logoutNote: "Parolni o'zgartirsangiz, boshqa qurilmalardan chiqib ketasiz.",
  ...
  stats: {
    studyPath: {
      ...
      section: "B{{n}}",
      breakdown: "Nimani qancha tugatdingiz",
      kinds: {
        words: "So'zlar",
        grammar: "Grammatika",
        review: "Takrorlash",
      ...
      examOpen: "Bitiruv imtihoni ochildi",
      examPassed: "Bitiruv imtihoni topshirildi!",
      nextLevel: "Keyingi: {{title}}",
      keepGoing: "Bu darajani tugatsangiz bitiruv imtihoni ochiladi",
    },
    momentum: {
      title: "Oxirgi 2 hafta",
      thisWeek: "Bu hafta {{n}} kun shug'ullandingiz",
      thisWeekShort: "Bu hafta",
      lastWeek: "O'tgan hafta",
      up: "O'tgan haftadan +{{n}} kun",
      down: "O'tgan haftadan -{{n}} kun",
      same: "O'tgan hafta bilan bir xil",
    },
    ...
    radar: {
      title: "O'quv balansi",
      range: "Oxirgi {{days}} kun",
      notYet: "Boshlanmagan",
      foot: "Oxirgi {{count}} ta savol asosida hisoblandi",
      diagnosis: {
        noData: "Yana bir oz mashq qiling — kuchli va zaif tomonlaringizni aytaman.",
        balanced: "Hamma yo'nalishni bir tekis olib boryapsiz. Shunday davom eting!",
        weakSpot: "{{weakest}} boshqa yo'nalishlardan ancha orqada.",
        untouched: "{{category}} hali boshlanmagan. Sinab ko'rasizmi?",
        accuracyDrop: "{{category}} bo'yicha ko'p ishlayapsiz, lekin to'g'ri javob kam. Takrorlash kerak.",
      },
    },
  ...
  courses: {
    ...
    categoryDesc: {
      ...
      speaking: "Mavzu bo'yicha gaplarni takrorlang",
  ...
  lessonComplete: {
    share: {
      title: "Dars tugadi!",
      headline: "Hozirgina koreys tili darsini tugatdim! 🔥",
      stats: "⚡ {{xp}} XP · 🎯 Aniqlik {{accuracy}}% · ⏱ {{time}}",
      streak: "🗓 {{days}} kun ketma-ket shug'ullanyapman!",
      invite: "Sen ham KORIO'ga qo'shil — taklif kodim {{code}}, kiritsang gem olasan.\n{{link}}",
      plain: "KORIO'da koreys tilini o'rganyapman 🇰🇷",
    },
  ...
  tutor: {
    ...
    summary: {
      analyzing: "Suhbat tahlil qilinmoqda...",
      title: "Suhbat tugadi!",
      statTime: "Suhbat vaqti",
      statSpoke: "Gapirdingiz",
      statWords: "Yangi ibora",
      didWell: "Yaxshi aytdingiz",
      betterWay: "Bunday desangiz yanada yaxshi",
      newWords: "Bugungi iboralar",
      reviewHint: "To'g'ri talaffuzni eshitish uchun bosing",
      again: "Yana suhbatlashish",
      done: "Tayyor",
    },
  ...
  invite: {
    ...
    copied: "Nusxalandi",
    openInvite: "Takliflarimni ko'rish",
  ...
  practice: {
    ...
    pronunciation: "Talaffuz",
    games: "O‘yinlar",
    mistakesHint: "Faqat xato qilganlaringizni qayta",
    wordsHint: "O‘rgangan so‘zlar kartochkada",
    speakingHint: "Mavzu tanlab, ovoz chiqarib",
    listeningHint: "O‘qib va tinglab o‘rganish",
    pronunciationHint: "Batchim va jamo tovushlarini sayqallash",
    gamesHint: "O‘ynab so‘zlarni mustahkamlash",
  },
  wordStudy: {
    ...
    recallShort: "Takror",
    recallBadge: "Yodlash mashqi",
    recallOfferEyebrow: "Barcha so'zlarni ko'rdingiz",
    recallOfferTitle: "Endi eslab ko'ramizmi?",
    recallOfferDescription:
      "Hozirgina ko'rgan {{count}} ta so'zni ma'nosiga qarab yozib, xotirangizni tekshiring.",
    recallOfferStart: "Mashqni boshlash",
    recallOfferLater: "Keyinroq",
    recallCountHint: "Hali tekshirilmagan so'z",
    recallPrompt: "Ma'nosiga qarab eslang",
    recallInputLabel: "Koreyscha so'z",
    recallCheck: "Javobni tekshirish",
    recallCorrect: "To'g'ri!",
    recallCorrectSub: "Endi keyingi so'zga o'tishingiz mumkin.",
    recallWrong: "Yana bir bor eslang",
    recallWrongSub: "Bu yaqinda ko'rgan so'zingiz. Qayta yozib ko'ring.",
    recallGuide: "Koreyschasini eslang",
    recallGuideSub: "Bo'shliq va tinish belgilaridagi farq qabul qilinadi.",
    recallAnswer: "Javob",
    recallHint: "Yordam",
    recallHintInstruction: "Ko'rsatilgan javobni o'zingiz yozib tekshiring.",
    recallContinue: "To'g'ri! Davom etish uchun suring",
    recallAnswerFirst: "Koreyscha so'zni yozib tekshiring",
  ...
  scoreUp: {
    ...
    sub: "{{unit}}-bo‘limni oxirigacha tugatdingiz. Shu tezlikda keyingi qism ham yaqin.",
    continue: "Davom etish",
  },
  jump: {
    passTitle: "Unit {{unit}} ochildi!",
    passSectionTitle: "{{section}}-bo‘lim ochildi!",
    passSectionSub: "Testdan o‘tdingiz. {{section}}-bo‘limdan darrov davom eting.",
    passUnitTitle: "{{unit}}-dars ochildi!",
    passUnitSub: "Testdan o‘tdingiz. {{unit}}-darsdan davom eting.",
    unlockedSectionLabel: "BO‘LIM OCHILDI",
    unlockedUnitLabel: "DARS OCHILDI",
    skippedLessons: "{{count}} ta darsni o‘tkazib yubordingiz",
    wrongCount: "{{count}} ta xato qildingiz",
    goStudy: "O‘qishni boshlash",
  ...
  shop: {
    premiumTitle: "Premium muddat",
    premiumDesc: "To'plagan gavharlaringizga KORIO SUPER'ni yana bir necha kun oling. Muddat uzoq bo'lsa, kuniga arzonroq.",
    premiumUntil: "{{date}} gacha premium",
    days: "{{n}} kun",
    perDay: "Kuniga {{n}} gavhar",
    save: "{{n}}% tejash",
    ...
    best: "ENG ZO'R",
    need: "yana {{n}} ta",
    stackFull: "Yetarlicha to'plangan",
    stackNote: "Hozir {{now}} kun to'plangan (ko'pi bilan {{max}} kun)",
    balance: "Gavharlarim",
    gemWorth: "1 gavhar = 1 so'm",
    superTitle: "KORIO SUPER",
    superPitch: "Cheksiz energiya · hech qachon to'xtamaysiz",
    superActive: "Hozir yoqilgan",
    superManage: "Boshqarish",
    confirmTitle: "Shu muddatni olasizmi?",
    confirmBody: "{{gems}} gavhar sarflab, {{days}} kunlik premium olasiz.",
    confirmOk: "Olaman",
    withdrawCardNumber: "Karta raqami",
    withdrawPayout: "{{n}} so'm olasiz",
    withdrawMin: "Eng kami {{n}} gavhardan boshlanadi",
    withdrawTooBig: "Sizda {{n}} gavhar bor",
    passesUnavailable: "Muddatlarni yuklab bo'lmadi. Server javob bermayapti.",
    freeLeft: "{{n}} ta bepul qoldi",
    withdrawSection: "Gavharni yechish",
    withdrawTitle: "Kartaga o'tkazish",
    withdrawDesc: "To'plagan gavharlaringizni kartaga qaytarib oling. Karta turini tanlab, raqamini kiriting.",
    withdrawAmount: "Gavhar miqdori",
    withdrawMax: "Hammasi",
    withdrawSubmit: "So'rov yuborish",
    ...
    errors: {
      ...
      UNKNOWN: "Birozdan keyin qayta urinib ko'ring.",
    },
  },
  challenge: {
    types: {
      ...
      swipeJudge: "To‘g‘ri yoki noto‘g‘ri",
      particleRush: "Chaqmoq yugurish",
      echoChain: "Tinglab takrorlash",
      wordChain: "So‘z zanjiri jangi",
      speed: "Tezlik raundi",
      listen: "Tinglash sinovi",
    },
    playsLeft: "Bugun qolgan urinishlar",
  ...
  expressionLearning: {
    ...
    practice: {
      stage: {
        ...
        guided: "2-bosqich · Takrorlash",
        recall: "3-bosqich · Eslash",
      },
      speakPrompt: {
      ...
      typePrompt: "Koreyscha iborani to'ldiring",
      speakMode: "Gapirish mashqi",
      typeMode: "Jim yozish",
      recallPrompt: "Ma'nosidan koreyscha iborani eslang",
      passed: "Juda tabiiy aytdingiz!",
      needsPractice: "Bu iborani yana bir marta mashq qilamiz",
      typePlaceholder: "Koreyscha yozing",
      tryAgain: "Biroz farq qiladi. Tekshirib, qayta yozing",
      correct: "To'g'ri!",
      hint: "Yordam",
      check: "Javobni tekshirish",
      later: "Keyinroq yana mashq qilish",
      completeToContinue: "Mashq qiling yoki keyinroq takrorlashni tanlang",
    },
