...
export default {
  ...
  studyPath: {
    ...
    desc: {
      grammar: "Avval bugungi grammatika qoidasini o'rganing.",
      words: "Bugungi so'zlarni kartochkalar bilan yodlang.",
      lesson: "O'rganganingizni mashqlarda sinab ko'ring.",
      practice: "Bugun o'rganganlaringiz aralash keladi.",
      review: "Avval xato qilgan savollaringizni ko'ring.",
      final: "Bugungi darsni oxirgi marta tekshiring.",
    },
  },
};
