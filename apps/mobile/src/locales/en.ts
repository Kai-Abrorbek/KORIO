...
export default {
  ...
  studyPath: {
    lessonProgress: "Lesson {{done}}/{{total}}",
    continueLesson: "Start lesson {{n}}",
    title: "Study path",
    dayLabel: "Day {{n}}",
    ...
    node: {
      ...
      vocabQuiz1: "Vocabulary ①",
      vocabQuiz2: "Vocabulary ②",
    ...
    desc: {
      ...
      vocabQuiz1: "Put today's words into questions.",
      vocabQuiz2: "Finish the rest of the vocabulary questions.",
