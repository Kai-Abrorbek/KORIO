...
export default {
  ...
  studyPath: {
    ...
    desc: {
      grammar: "Start with today's grammar rule.",
      words: "Learn today's words with cards.",
      lesson: "Put what you learned into questions.",
      practice: "Everything from today, mixed together.",
      review: "Go back to the ones you got wrong.",
      final: "One last check on today's lesson.",
    },
  },
};
