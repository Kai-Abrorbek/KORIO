    ...
    <View style={styles.panel}>
      <View style={styles.header}>
        <View>
          <Text style={styles.eyebrow}>
            {t("topik.modes.guided").toUpperCase()}
          </Text>
      ...
      {support?.revealedHints.map((hint) => (
        <View key={hint.key} style={styles.hintCard}>
          ...
          <Text style={styles.hintTitle}>
            {topikText(hint.title, language)}
          </Text>
          <Text style={styles.hintContent}>
            {topikText(hint.content, language)}
          </Text>
      ...
      {solution && (
        <View style={styles.solutionCard}>
          ...
          <Text style={styles.solutionHeading}>
            {t("topik.hint.explanation")}
          </Text>
          <Text style={styles.solutionText}>
      ...
      {!solution && !selected && (
        <Text style={styles.guideText}>
          {t("topik.hint.selectAnswerFirst")}
        </Text>
      )}
    </View>
  );
