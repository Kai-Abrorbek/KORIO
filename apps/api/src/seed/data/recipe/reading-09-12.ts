...
const practice = [
  ...
  q(
    'recipe-reading-09-12-practice-07',
    7,
    TopikQuestionType.PASSAGE_CONTENT_MATCH,
    '1인 가구가 증가하면서 혼자 식사를 하는 사람, 이른바 ‘혼밥’이 늘고 있다. 몇 년 전만 해도 식당에서 혼자 밥을 먹는 모습은 낯설었다. 하지만 요즘 식당에 가 보면 1인 고객이 상당한 비중을 차지하고 있다. 이에 발맞추어 외식업계에서는 ‘1인 삼겹살’, ‘1인 보쌈’ 등 1인분 식단을 선보이고 있다. 부담 없는 가격에 1인 고객이나 소비자들은 높은 만족도를 보이고 있다.',
    [
      '식당에서 혼자 식사를 하는 사람은 자주 볼 수 없다.',
      '1인분 식단은 소비자들에게 좋은 반응을 얻고 있다.',
      '혼자 식사를 하는 사람들이 증가한 것은 물가 때문이다.',
      '외식업계에서는 1인분 식단에 대해 부담스럽게 생각한다.',
    ],
    1,
    '합격 레시피 읽기 11~12번 예상문제 3 / 91쪽',
  ),
  q(
    'recipe-reading-09-12-practice-08',
    8,
    TopikQuestionType.PASSAGE_CONTENT_MATCH,
    '집에서 쓰던 텔레비전이나 세탁기를 버리려면 돈을 주고 스티커를 사서 물건에 붙여야 한다고 아는 사람이 많다. 그러나 2012년부터 환경부에서 시행하고 있는 제도를 이용하면 가전제품을 무료로 버릴 수 있다는 사실을 아는 사람은 많지 않다. 환경부 홈페이지를 통해 신청을 하면 직원이 직접 집으로 방문해서 버릴 물건을 무료로 가져가 준다.',
    [
      '이 서비스는 앞으로 시행할 예정이다.',
      '환경부에 직접 방문해서 신청해야 한다.',
      '신청을 하면 버릴 가전제품을 가지러 온다.',
      '환경부 홈페이지를 통해 스티커를 구입해야 한다.',
    ],
    2,
    '합격 레시피 읽기 11~12번 예상문제 4 / 91쪽',
  ),
];
