...
export const GRAMMAR_SEED_S2: any[] = [
  ...
  // ───────── 섹션 2-9. ㄹ 받침의 변화 'ㄹ' 탈락 ─────────
  {
    ...
    summary: {
      ko: '어간이 ㄹ 받침으로 끝나는 동사·형용사가 특정 어미를 만나면 ㄹ이 없어지는 변화예요. 특히 ㄴ, ㅂ, ㅅ으로 시작하는 어미 앞에서 자주 일어나요.',
      uz: 'Fe’l yoki sifat negizi ㄹ bilan tugab, ayrim qo‘shimchalarni uchratganda ㄹ tushib qoladi. Ayniqsa ㄴ, ㅂ, ㅅ bilan boshlanadigan qo‘shimchalar oldidan ko‘p uchraydi.',
      en: 'When a verb or adjective stem ends in ㄹ, the ㄹ disappears before certain endings, especially endings beginning with ㄴ, ㅂ, or ㅅ.',
      ru: 'Если основа глагола или прилагательного оканчивается на ㄹ, перед некоторыми окончаниями ㄹ выпадает, особенно перед ㄴ, ㅂ и ㅅ.',
    },
    ...
    explanation: {
      ko: '동사나 형용사의 기본형에서 "-다"를 뺀 어간이 ㄹ로 끝날 때, 뒤에 오는 어미에 따라 ㄹ이 그대로 남기도 하고 사라지기도 해요. 특히 ㄴ, ㅂ, ㅅ으로 시작하는 어미 앞에서는 ㄹ이 탈락하는 경우가 많아요. 예를 들어 "살다"에 "-세요"를 붙이면 "살세요"가 아니라 "사세요"가 되고, "알다"에 "-ㅂ니다"를 붙이면 "알ㅂ니다"가 아니라 "압니다"가 돼요. 하지만 모든 어미 앞에서 ㄹ이 없어지는 것은 아니에요. "살아요", "살고", "살지 마세요"처럼 ㄹ이 그대로 유지되는 표현도 있어요. 따라서 단순히 "ㄹ 받침이면 삭제한다"고 외우기보다 어떤 어미가 뒤에 오는지를 함께 보는 것이 중요해요.',
      uz: 'Asosiy shakldan "-다" olib tashlanganda negiz ㄹ bilan tugasa, keyingi qo‘shimchaga qarab ㄹ saqlanishi yoki tushishi mumkin. Ayniqsa ㄴ, ㅂ, ㅅ bilan boshlanuvchi qo‘shimchalar oldidan ㄹ ko‘pincha tushadi. Masalan, 살다 + -세요 → 사세요, 알다 + -ㅂ니다 → 압니다. Lekin har bir qo‘shimcha oldidan ㄹ tushmaydi. 살아요, 살고, 살지 마세요 kabi shakllarda ㄹ saqlanadi. Shuning uchun faqat ㄹ ga emas, undan keyin keladigan qo‘shimchaga ham qarash kerak.',
      en: 'Remove -다 to find the stem. If the stem ends in ㄹ, that ㄹ may remain or disappear depending on the following ending. It commonly disappears before endings beginning with ㄴ, ㅂ, or ㅅ. For example, 살다 + -세요 becomes 사세요, not 살세요, and 알다 + -ㅂ니다 becomes 압니다. However, ㄹ does not disappear before every ending. It remains in forms such as 살아요, 살고, and 살지 마세요. Always check the following ending rather than deleting ㄹ automatically.',
      ru: 'Если после удаления -다 основа заканчивается на ㄹ, этот ㄹ может сохраняться или выпадать в зависимости от следующего окончания. Перед окончаниями на ㄴ, ㅂ и ㅅ он часто исчезает. Например, 살다 + -세요 → 사세요, а 알다 + -ㅂ니다 → 압니다. Однако ㄹ выпадает не всегда: в 살아요, 살고 и 살지 마세요 он сохраняется. Поэтому важно смотреть на следующее окончание.',
    },

    conjugationRule: {
      ko: 'ㄹ 받침 어간 + ㄴ/ㅂ/ㅅ 계열 어미 → ㄹ 탈락 · 그 외 어미에서는 ㄹ이 유지되는 경우가 많음',
      uz: 'ㄹ bilan tugagan negiz + ㄴ/ㅂ/ㅅ turidagi qo‘shimcha → ㄹ tushadi · boshqa qo‘shimchalarda ko‘pincha saqlanadi',
      en: 'ㄹ-final stem + endings beginning with ㄴ/ㅂ/ㅅ → ㄹ deletion · ㄹ often remains before other endings',
      ru: 'Основа на ㄹ + окончания с ㄴ/ㅂ/ㅅ → ㄹ выпадает · перед другими окончаниями часто сохраняется',
    },
    ...
    examples: [
      ...
      },
      {
        ...
        gloss: {
          ko: '이 약을 아세요?',
          uz: 'Bu dorini bilasizmi?',
          en: 'Do you know this medicine?',
          ru: 'Вы знаете это лекарство?',
        },
      },
      {
        ko: '문을 여세요.',
      ...
      },
      {
        ...
        gloss: {
          ko: '여기에서 과일을 파세요.',
          uz: 'Bu yerda meva sotasizmi?',
          en: 'Do you sell fruit here?',
          ru: 'Здесь продают фрукты?',
        },
      },
      {
        ko: '저는 서울에 삽니다.',
      ...
      },
      {
        ...
        gloss: {
          ko: '이 길은 아주 깁니다.',
          uz: 'Bu yo‘l juda uzun.',
          en: 'This road is very long.',
          ru: 'Эта дорога очень длинная.',
        },
      },
      {
        ko: '학교가 집에서 멉니다.',
        ...
        gloss: {
          ko: '학교가 집에서 멉니다.',
          uz: 'Maktab uydan uzoq.',
          en: 'The school is far from my house.',
          ru: 'Школа далеко от дома.',
        },
      },
      {
        ko: '긴 머리가 잘 어울려요.',
        ...
        gloss: {
          ko: '긴 머리가 잘 어울려요.',
          uz: 'Uzun soch sizga yarashadi.',
          en: 'Long hair suits you well.',
          ru: 'Вам идут длинные волосы.',
        },
      },
      {
        ko: '먼 곳에 가지 마세요.',
        ...
        gloss: {
          ko: '먼 곳에 가지 마세요.',
          uz: 'Uzoq joyga bormang.',
          en: 'Please do not go somewhere far away.',
          ru: 'Не уходите далеко.',
        },
      },
    ],
    ...
    dialogue: [
      ...
      },
      {
        ...
        gloss: {
          ko: '학교 근처에 살아요.',
          uz: 'Maktab yaqinida yashayman.',
          en: 'I live near the school.',
          ru: 'Я живу рядом со школой.',
        },
      },
      {
        speaker: 'A',
        ...
        gloss: {
          ko: '이 근처에 좋은 병원을 아세요?',
          uz: 'Bu atrofda yaxshi shifoxonani bilasizmi?',
          en: 'Do you know a good hospital around here?',
          ru: 'Вы знаете хорошую больницу поблизости?',
        },
      },
      {
        speaker: 'B',
        side: 'right',
        ko: '네, 알아요. 여기에서 조금 멀어요.',
        highlight: '멀어요',
        gloss: {
          ko: '네, 알아요. 여기에서 조금 멀어요.',
          uz: 'Ha, bilaman. Bu yerdan biroz uzoq.',
          en: 'Yes, I do. It is a little far from here.',
          ru: 'Да. Она немного далеко отсюда.',
        },
      },
    ],
    ...
    similar: {
      pattern: 'ㄹ 유지',
      note: {
        ko: 'ㄹ 받침이라고 해서 항상 ㄹ이 사라지는 것은 아니에요. "-아요/어요", "-고", "-지"처럼 ㄹ 탈락 조건이 아닌 어미 앞에서는 "살아요, 살고, 살지"처럼 ㄹ이 그대로 남아요.',
        uz: 'Negiz ㄹ bilan tugashi uning har doim tushishini anglatmaydi. -아요/어요, -고, -지 kabi qo‘shimchalar oldidan ㄹ saqlanadi.',
        en: 'A ㄹ-final stem does not always lose ㄹ. Before endings such as -아요/어요, -고, and -지, ㄹ remains: 살아요, 살고, 살지.',
        ru: 'ㄹ не выпадает автоматически. Перед -아요/어요, -고 и -지 он сохраняется: 살아요, 살고, 살지.',
      },
    },

    cautions: [
      {
        ko: '"살다 + -세요"를 "살세요"라고 하지 않아요. ㄹ이 탈락해서 "사세요"가 돼요.',
        uz: '살다 + -세요 shakli "살세요" emas, ㄹ tushib "사세요" bo‘ladi.',
        en: '살다 + -세요 is 사세요, not 살세요.',
        ru: '살다 + -세요 даёт 사세요, а не 살세요.',
      },
      {
        ko: '"만들다"도 "만들세요"가 아니라 "만드세요"라고 해요.',
        uz: '만들다 ham "만들세요" emas, "만드세요" bo‘ladi.',
        en: '만들다 becomes 만드세요, not 만들세요.',
        ru: '만들다 превращается в 만드세요, а не 만들세요.',
      },
      {
        ko: '"-지 마세요" 앞에서는 ㄹ이 탈락하지 않아요. "살지 마세요", "열지 마세요"처럼 써요.',
        uz: '-지 마세요 oldidan ㄹ tushmaydi: 살지 마세요, 열지 마세요.',
        en: 'ㄹ does not disappear before -지 마세요. Use 살지 마세요 and 열지 마세요.',
        ru: 'Перед -지 마세요 ㄹ сохраняется: 살지 마세요, 열지 마세요.',
      },
      {
        ko: '기본형만 보고 ㄹ을 지우지 말고, 반드시 뒤에 붙는 어미까지 확인해야 해요.',
        uz: 'Faqat asosiy shaklga qarab ㄹ ni olib tashlamang; keyingi qo‘shimchani ham tekshiring.',
        en: 'Do not delete ㄹ just because the dictionary form ends in ㄹ. Check the following ending.',
        ru: 'Не удаляйте ㄹ только из-за формы слова. Сначала посмотрите на следующее окончание.',
      },
    ],
    ...
    quiz: [
      {
        question: {
          ko: '"살다 + -세요"의 알맞은 형태를 고르세요.',
          uz: '"살다 + -세요"ning to‘g‘ri shaklini tanlang.',
      ...
      },
      {
        question: {
          ko: '"만들다 + -세요"의 알맞은 형태는?',
          uz: '"만들다 + -세요"ning to‘g‘ri shakli qaysi?',
          en: 'What is the correct form of 만들다 + -세요?',
          ru: 'Какая форма 만들다 + -세요 правильная?',
        },
        options: [
          { text: '만드세요', correct: true },
          { text: '만들세요', correct: false },
          { text: '만들으세요', correct: false },
        ],
      },
      {
        question: {
      ...
      {
        question: {
          ko: 'ㄹ이 탈락하지 않는 표현을 고르세요.',
          uz: 'ㄹ tushmaydigan shaklni tanlang.',
          en: 'Choose the form in which ㄹ does not disappear.',
          ru: 'Выберите форму, в которой ㄹ не выпадает.',
        },
        options: [
          { text: '살지 마세요', correct: true },
      ...
      },
      {
        ...
        options: [
          { text: '문을 여세요.', correct: true },
          { text: '문을 열세요.', correct: false },
          { text: '문을 열으세요.', correct: false },
        ],
      },
    ],
  },
