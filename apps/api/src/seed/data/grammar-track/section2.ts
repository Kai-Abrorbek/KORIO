...
function build(
  ...
  const full = rows.map((row) => row.correct).join(' ');
...
const G1_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['이름은', '이름을', '이름에서'],
        correct: '이름은',
      },
      {
        options: ['유나예요.', '유나를요.', '유나에서요.'],
        correct: '유나예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['제 친구의', '제 친구를', '제 친구가'],
        correct: '제 친구의',
      },
      {
        options: ['아버지예요.', '아버지를요.', '아버지에서요.'],
        correct: '아버지예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['선생님의', '선생님을', '선생님이'],
        correct: '선생님의',
      },
      {
        options: ['우산이에요.', '우산을이에요.', '우산가예요.'],
        correct: '우산이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['저분은', '저분을', '저분에게'],
        correct: '저분은',
      },
      {
        options: ['민수 씨의', '민수 씨를', '민수 씨가'],
        correct: '민수 씨의',
      },
      {
        options: ['어머니예요.', '어머니를예요.', '어머니가예요.'],
        correct: '어머니예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['다섯 명이에요.', '다섯 명을이에요.', '다섯 명가예요.'],
        correct: '다섯 명이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['친구는', '친구를', '친구의는'],
        correct: '친구는',
      },
      {
        options: ['한국 사람이에요.', '한국 사람을이에요.', '한국 사람가예요.'],
        correct: '한국 사람이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['아버지의', '아버지를', '아버지가'],
        correct: '아버지의',
      },
      {
        options: ['회사예요.', '회사를예요.', '회사에서예요.'],
        correct: '회사예요.',
      },
    ],
    {
...
const G2_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['운전을', '운전이', '운전은를'],
        correct: '운전을',
      },
      {
        options: ['잘 못해요.', '잘해요.', '잘 못를 해요.'],
        correct: '잘 못해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['마리아는', '마리아를', '마리아에서'],
        correct: '마리아는',
      },
      {
        options: ['한국어를', '한국어가', '한국어을'],
        correct: '한국어를',
      },
      {
        options: ['잘해요.', '못해요.', '잘을 해요.'],
...
const G3_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['아버지는', '아버지를', '아버지가를'],
        correct: '아버지는',
      },
      {
        options: ['회사원이세요.', '회사원세요.', '회사원이에요.'],
        correct: '회사원이세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이분은', '이분을', '이분에서'],
        correct: '이분은',
      },
      {
        options: ['의사세요.', '의사이세요.', '의사이에요.'],
        correct: '의사세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['우리 할머니는', '우리 할머니를', '우리 할머니가를'],
        correct: '우리 할머니는',
      },
      {
        options: ['선생님이세요.', '선생님세요.', '선생님이에요.'],
        correct: '선생님이세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['수진 씨의', '수진 씨를', '수진 씨가'],
        correct: '수진 씨의',
      },
      {
        options: ['어머니는', '어머니를', '어머니에서'],
        correct: '어머니는',
      },
      {
        options: ['기자세요.', '기자이세요.', '기자이에요.'],
        correct: '기자세요.',
      },
    ],
    {
...
const G4_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['회사에', '회사를', '회사에서를'],
        correct: '회사에',
      },
      {
        options: ['다니세요.', '다녀요.', '다니으세요.'],
        correct: '다니세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['우리 할머니는', '우리 할머니를', '우리 할머니에서'],
        correct: '우리 할머니는',
      },
      {
        options: ['친구가', '친구를', '친구는를'],
        correct: '친구가',
      },
      {
        options: ['많으세요.', '많세요.', '많아요.'],
        correct: '많으세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['부산에', '부산을', '부산이가'],
        correct: '부산에',
      },
      {
        options: ['가셨어요.', '가세요.', '갔어요.'],
        correct: '가셨어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['이 책을', '이 책이', '이 책를'],
        correct: '이 책을',
      },
      {
        options: ['읽으셨어요.', '읽으세요.', '읽었어요.'],
        correct: '읽으셨어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['요리를', '요리가', '요리는를'],
        correct: '요리를',
      },
      {
        options: ['잘하세요.', '잘해요.', '잘으세요.'],
        correct: '잘하세요.',
      },
    ],
    {
...
const G5_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['수업은', '수업을', '수업에서'],
        correct: '수업은',
      },
      {
        options: ['아홉 시에', '아홉 시간을', '아홉 시부터까지'],
        correct: '아홉 시에',
      },
      {
        options: ['시작해요.', '시작했어요.', '시작하지 마세요.'],
        correct: '시작해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['약속은', '약속을', '약속에서'],
        correct: '약속은',
      },
      {
        options: ['오후 두 시예요.', '오전 두 시예요.', '두 시간이에요.'],
        correct: '오후 두 시예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['영화는', '영화를', '영화에서'],
        correct: '영화는',
      },
      {
        options: ['여섯 시 반에', '여섯 시 반을', '여섯 시간 반에'],
        correct: '여섯 시 반에',
      },
      {
        options: ['시작해요.', '일어나요.', '먹어요.'],
        correct: '시작해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['회의는', '회의를', '회의가를'],
        correct: '회의는',
      },
      {
        options: ['오전 열 시예요.', '오후 열 시예요.', '열 시간이에요.'],
        correct: '오전 열 시예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['저녁을', '저녁이', '저녁에를'],
        correct: '저녁을',
      },
      {
        options: ['일곱 시에', '일곱 시간을', '일곱 분에'],
        correct: '일곱 시에',
      },
      {
        options: ['먹어요.', '자요.', '읽어요.'],
...
const G6_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['아홉 시부터', '아홉 시까지', '아홉 시에'],
        correct: '아홉 시부터',
      },
      {
        options: ['열두 시까지예요.', '열두 시부터예요.', '열두 시에부터예요.'],
        correct: '열두 시까지예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['방학은', '방학을', '방학에서'],
        correct: '방학은',
      },
      {
        options: ['칠월부터', '칠월까지', '칠월에'],
        correct: '칠월부터',
      },
      {
        options: ['팔월까지예요.', '팔월부터예요.', '팔월에예요.'],
        correct: '팔월까지예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['점심시간은', '점심시간을', '점심시간에서'],
        correct: '점심시간은',
      },
      {
        options: ['열두 시부터', '열두 시까지', '열두 시에'],
        correct: '열두 시부터',
      },
      {
        options: ['한 시까지예요.', '한 시부터예요.', '한 시를예요.'],
        correct: '한 시까지예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['도서관은', '도서관을', '도서관에서'],
        correct: '도서관은',
      },
      {
        options: ['아침부터', '아침까지', '아침에만'],
        correct: '아침부터',
      },
      {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['오전 아홉 시부터', '오전 아홉 시까지', '오전 아홉 시간을'],
        correct: '오전 아홉 시부터',
      },
      {
        options: ['오후 여섯 시까지', '오후 여섯 시부터', '오후 여섯 시를'],
        correct: '오후 여섯 시까지',
      },
      {
        options: ['회사에 있어요.', '회사에서 가요.', '회사를 있어요.'],
        correct: '회사에 있어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['행사는', '행사를', '행사에서'],
        correct: '행사는',
      },
      {
        options: ['오늘부터', '오늘까지', '오늘에'],
        correct: '오늘부터',
      },
      {
        options: ['일요일까지예요.', '일요일부터예요.', '일요일에부터예요.'],
        correct: '일요일까지예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['회의는', '회의를', '회의에서'],
        correct: '회의는',
      },
      {
        options: ['두 시부터', '두 시까지', '두 시에'],
        correct: '두 시부터',
      },
      {
        options: ['네 시까지', '네 시부터', '네 시에서'],
        correct: '네 시까지',
      },
      {
        options: ['계속돼요.', '먹어요.', '출발해요.'],
        correct: '계속돼요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['토요일까지', '토요일부터', '토요일에부터'],
        correct: '토요일까지',
      },
      {
        options: ['문을 열어요.', '문을 먹어요.', '문에 가요.'],
        correct: '문을 열어요.',
      },
    ],
    {
...
const G7_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['은행에', '은행을', '은행에서를'],
        correct: '은행에',
      },
      {
        options: ['가서', '가고 싶어서', '갈 거예요'],
        correct: '가서',
      },
      {
        options: ['돈을 찾았어요.', '돈이 갔어요.', '돈을 만났어요.'],
        correct: '돈을 찾았어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['친구를', '친구가', '친구에서'],
        correct: '친구를',
      },
      {
        options: ['만나서', '만나면', '만날 거예요'],
        correct: '만나서',
      },
      {
        options: [
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['숙제를 했어요.', '숙제에 갔어요.', '숙제가 왔어요.'],
        correct: '숙제를 했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['과일을 샀어요.', '과일이 갔어요.', '과일을 왔어요.'],
        correct: '과일을 샀어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['앉아서', '앉으면', '앉을 거예요'],
        correct: '앉아서',
      },
      {
        options: ['커피를 마셨어요.', '커피가 앉았어요.', '커피를 갔어요.'],
        correct: '커피를 마셨어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['열어서', '열면', '열 거예요'],
        correct: '열어서',
      },
      {
        options: ['방에 들어갔어요.', '방을 먹었어요.', '방이 열었어요.'],
        correct: '방에 들어갔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['학교에 갔어요.', '학교를 탔어요.', '학교가 왔어요.'],
        correct: '학교에 갔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['아침에', '아침을', '아침에서'],
        correct: '아침에',
      },
      {
        options: ['일어나서', '일어나면', '일어날 거예요'],
        correct: '일어나서',
      },
      {
        options: ['샤워했어요.', '샤워를 갔어요.', '샤워가 먹었어요.'],
        correct: '샤워했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['사진을', '사진이', '사진에서'],
        correct: '사진을',
      },
      {
        options: ['찍어서', '찍으면', '찍을 거예요'],
        correct: '찍어서',
      },
      {
        options: ['친구에게 보냈어요.', '친구를 찍었어요.', '친구가 보냈어요.'],
        correct: '친구에게 보냈어요.',
      },
    ],
    {
...
const G8_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['한국어를', '한국어가', '한국어에서'],
        correct: '한국어를',
      },
      {
        options: ['공부할 거예요.', '공부했어요.', '공부하고 있어요.'],
        correct: '공부할 거예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['토요일에', '지난 토요일에', '지금'],
        correct: '토요일에',
      },
      {
        options: ['영화를', '영화가', '영화에서'],
        correct: '영화를',
      },
      {
        options: ['볼 거예요.', '봤어요.', '보고 있어요.'],
        correct: '볼 거예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['부모님께', '부모님을', '부모님에서'],
        correct: '부모님께',
      },
      {
        options: ['전화할 거예요.', '전화했어요.', '전화하고 있어요.'],
        correct: '전화할 거예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['청소할 거예요.', '청소했어요.', '청소하고 있어요.'],
        correct: '청소할 거예요.',
      },
    ],
    {
...
const G9_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['너무 바빠요.', '너무 바쁘어요.', '너무 바쁘아요.'],
        correct: '너무 바빠요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['걸려서', '걸리면', '걸릴 거예요'],
        correct: '걸려서',
      },
      {
        options: ['목이 아파요.', '목을 아파요.', '목이 아프어요.'],
        correct: '목이 아파요.',
      },
    ],
    {
...
const G10_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['운동하지 마세요.', '운동해 보세요.', '운동할게요.'],
        correct: '운동하지 마세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['너무 많이', '너무 많은', '너무 많아서'],
        correct: '너무 많이',
      },
      {
        options: ['먹지 마세요.', '먹어 보세요.', '먹을게요.'],
        correct: '먹지 마세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['수업 시간에', '수업 시간을', '수업 시간이'],
        correct: '수업 시간에',
      },
      {
        options: ['전화하지 마세요.', '전화해 보세요.', '전화할게요.'],
        correct: '전화하지 마세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['너무 늦게', '너무 늦은', '너무 늦어서'],
        correct: '너무 늦게',
      },
      {
        options: ['자지 마세요.', '자 보세요.', '잘 거예요.'],
        correct: '자지 마세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['아픈 곳을', '아픈 곳이', '아픈 곳에를'],
        correct: '아픈 곳을',
      },
      {
        options: ['만지지 마세요.', '만져 보세요.', '만질 거예요.'],
        correct: '만지지 마세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['병원 안에서', '병원 안을', '병원 안이'],
        correct: '병원 안에서',
      },
      {
        options: ['뛰지 마세요.', '뛰어 보세요.', '뛸 거예요.'],
        correct: '뛰지 마세요.',
      },
    ],
    {
...
const G11_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['주말에는', '주말을', '주말에서'],
        correct: '주말에는',
      },
      {
        options: ['집에서만', '집에도', '집을만'],
        correct: '집에서만',
      },
      {
        options: ['쉬었어요.', '일했어요.', '갔어요.'],
        correct: '쉬었어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['민수 씨만', '민수 씨도', '민수 씨를만'],
        correct: '민수 씨만',
      },
      {
        options: ['병원에', '병원을', '병원에서를'],
        correct: '병원에',
      },
      {
        options: ['갔어요.', '먹었어요.', '잤어요.'],
        correct: '갔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['집에 갈 거예요.', '집에서 먹었어요.', '집을 만날 거예요.'],
        correct: '집에 갈 거예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이 약은', '이 약을', '이 약에서'],
        correct: '이 약은',
      },
      {
        options: ['저녁에만', '저녁에도', '저녁을만'],
        correct: '저녁에만',
      },
      {
        options: ['드세요.', '가세요.', '주무세요.'],
        correct: '드세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['한국어만', '한국어도', '한국어를만'],
        correct: '한국어만',
      },
      {
        options: ['공부하고 있어요.', '먹고 있어요.', '자고 있어요.'],
        correct: '공부하고 있어요.',
      },
    ],
    {
...
const G12_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['하루에 세 번', '하루부터 세 번', '하루만 세 번'],
        correct: '하루에 세 번',
      },
      {
        options: ['먹어야 돼요.', '먹지 마세요.', '먹을 거예요.'],
        correct: '먹어야 돼요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['감기에 걸리면', '감기에 걸려서만', '감기를 걸리면'],
        correct: '감기에 걸리면',
      },
      {
...
const G13_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['이번 주말에', '어제', '지금부터까지'],
        correct: '이번 주말에',
      },
      {
        options: ['친구를', '친구가', '친구에게서'],
        correct: '친구를',
      },
      {
        options: ['만나려고 해요.', '만나고 싶어 해요.', '만나지 마세요.'],
        correct: '만나려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['제주도에', '제주도를', '제주도에서부터'],
        correct: '제주도에',
      },
      {
        options: ['가려고 해요.', '가야 돼요.', '가지 마세요.'],
        correct: '가려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['운동하려고 해요.', '운동하지 마세요.', '운동했어요.'],
        correct: '운동하려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['점심에', '점심을', '점심부터까지'],
        correct: '점심에',
      },
      {
        options: ['비빔밥을', '비빔밥이', '비빔밥에서'],
        correct: '비빔밥을',
      },
      {
        options: ['먹으려고 해요.', '먹어야 돼요.', '먹지 마세요.'],
        correct: '먹으려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['주말에는', '어제는', '지금은'],
        correct: '주말에는',
      },
      {
        options: ['집에서', '집에를', '집으로부터'],
        correct: '집에서',
      },
      {
        options: ['쉬려고 해요.', '쉬지 마세요.', '쉬었어요.'],
        correct: '쉬려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['부산에서', '부산을', '부산이가'],
        correct: '부산에서',
      },
      {
        options: ['살려고 해요.', '살으려고 해요.', '사려고 해요.'],
        correct: '살려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['집에 가서', '집을 가서', '집에 가면부터'],
        correct: '집에 가서',
      },
      {
        options: ['음악을', '음악이', '음악에서'],
        correct: '음악을',
      },
      {
        options: ['들으려고 해요.', '듣으려고 해요.', '듣지 마세요.'],
        correct: '들으려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['더 열심히', '더 열심한', '더 열심을'],
        correct: '더 열심히',
      },
      {
        options: ['공부하려고 해요.', '공부했어요.', '공부하지 마세요.'],
        correct: '공부하려고 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이번 여행에서', '이번 여행을', '이번 여행이가'],
        correct: '이번 여행에서',
      },
      {
        options: ['사진을', '사진이', '사진으로'],
        correct: '사진을',
      },
      {
        options: ['많이', '많은', '많아서'],
...
const G14_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['학교까지', '학교에서', '학교부터'],
        correct: '학교까지',
      },
      {
        options: ['걸어가요.', '먹어요.', '읽어요.'],
        correct: '걸어가요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['서울에서', '서울까지', '서울부터'],
        correct: '서울에서',
      },
      {
        options: ['부산까지', '부산에서', '부산부터'],
        correct: '부산까지',
      },
      {
        options: ['기차로 가요.', '기차를 먹어요.', '기차에 읽어요.'],
        correct: '기차로 가요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['공항에서', '공항까지', '공항으로부터를'],
        correct: '공항에서',
      },
      {
        options: ['호텔까지', '호텔에서', '호텔부터'],
        correct: '호텔까지',
      },
      {
        options: ['택시를 탔어요.', '택시가 먹었어요.', '택시에 읽었어요.'],
        correct: '택시를 탔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['학교에서', '학교까지', '학교부터'],
        correct: '학교에서',
      },
      {
        options: ['도서관까지', '도서관에서', '도서관부터'],
        correct: '도서관까지',
      },
      {
        options: ['십 분 걸려요.', '십 분을 가요.', '십 시 걸려요.'],
        correct: '십 분 걸려요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['여기에서', '여기까지', '여기를'],
        correct: '여기에서',
      },
      {
        options: ['지하철역까지', '지하철역에서', '지하철역부터'],
        correct: '지하철역까지',
      },
      {
        options: ['멀어요?', '먹어요?', '읽어요?'],
  ...
  ...build(
    ...
    [
      {
        options: ['서울역에서', '서울역까지', '서울역부터'],
        correct: '서울역에서',
      },
      {
        options: ['명동까지', '명동에서', '명동부터'],
        correct: '명동까지',
      },
      {
        options: ['지하철로 가세요.', '지하철을 가세요.', '지하철에서 가세요.'],
        correct: '지하철로 가세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['우리 집에서', '우리 집까지', '우리 집부터'],
        correct: '우리 집에서',
      },
      {
        options: ['회사까지', '회사에서', '회사부터'],
        correct: '회사까지',
      },
      {
        options: ['가까워요.', '먹어요.', '읽어요.'],
        correct: '가까워요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['버스 정류장에서', '버스 정류장까지', '버스 정류장을'],
        correct: '버스 정류장에서',
      },
      {
        options: ['병원까지', '병원에서', '병원부터'],
        correct: '병원까지',
      },
      {
        options: ['걸어서 갔어요.', '걸어서 먹었어요.', '걸어서 읽었어요.'],
        correct: '걸어서 갔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['인천에서', '인천까지', '인천부터'],
        correct: '인천에서',
      },
      {
        options: ['서울까지', '서울에서', '서울부터'],
        correct: '서울까지',
      },
      {
        options: [
...
const G15_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['조금만', '조금도', '조금을만'],
        correct: '조금만',
      },
      {
        options: ['기다려 주세요.', '기다리지 마세요.', '기다리려고 해요.'],
        correct: '기다려 주세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이 문장을', '이 문장이', '이 문장에'],
        correct: '이 문장을',
      },
      {
        options: ['읽어 주세요.', '읽지 마세요.', '읽으려고 해요.'],
        correct: '읽어 주세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['한국어로', '한국어를', '한국어에서'],
        correct: '한국어로',
      },
      {
        options: ['설명해 주세요.', '설명하지 마세요.', '설명하려고 해요.'],
        correct: '설명해 주세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['친구가', '친구를', '친구에게를'],
        correct: '친구가',
      },
      {
        options: ['숙제를', '숙제가', '숙제에서'],
        correct: '숙제를',
      },
      {
        options: ['도와줬어요.', '도와지 마세요.', '도우려고 해요.'],
        correct: '도와줬어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['아버지가', '아버지를', '아버지에게서'],
        correct: '아버지가',
      },
      {
        options: ['자전거를', '자전거가', '자전거에'],
        correct: '자전거를',
      },
      {
        options: ['고쳐 주셨어요.', '고치지 마셨어요.', '고칠 거예요만.'],
        correct: '고쳐 주셨어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['골라 주세요.', '고르지 마세요.', '고르려고 해요.'],
        correct: '골라 주세요.',
      },
    ],
    {
...
const G16_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['학교에', '학교를', '학교에서를'],
        correct: '학교에',
      },
      {
        options: ['버스로', '버스으로', '버스에'],
        correct: '버스로',
      },
      {
        options: ['가요.', '먹어요.', '읽어요.'],
  ...
  ...build(
    ...
    [
      {
        options: ['서울역까지', '서울역에서', '서울역을'],
        correct: '서울역까지',
      },
      {
        options: ['지하철로', '지하철으로', '지하철을'],
        correct: '지하철로',
      },
      {
        options: ['가세요.', '먹으세요.', '읽으세요.'],
        correct: '가세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['공항에', '공항을', '공항에서를'],
        correct: '공항에',
      },
      {
        options: ['택시로', '택시으로', '택시를'],
        correct: '택시로',
      },
      {
        options: ['갔어요.', '먹었어요.', '읽었어요.'],
        correct: '갔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['왼쪽으로', '왼쪽로', '왼쪽에'],
        correct: '왼쪽으로',
      },
      {
        options: ['도세요.', '드세요.', '읽으세요.'],
        correct: '도세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['한국에', '한국을', '한국에서를'],
        correct: '한국에',
      },
      {
        options: ['비행기로', '비행기으로', '비행기를'],
        correct: '비행기로',
      },
      {
  ...
  ...build(
    ...
    [
      {
        options: ['회사에는', '회사를', '회사에서를'],
        correct: '회사에는',
      },
      {
        options: ['자전거로', '자전거으로', '자전거를'],
        correct: '자전거로',
      },
      {
        options: ['다녀요.', '먹어요.', '읽어요.'],
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['앞으로', '앞으으로', '앞에를'],
        correct: '앞으로',
      },
      {
        options: ['가세요.', '드세요.', '읽으세요.'],
        correct: '가세요.',
      },
    ],
    {
...
const G17_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['긴 치마를', '길은 치마를', '길는 치마를'],
        correct: '긴 치마를',
      },
      {
        options: ['좋아해요.', '좋지 마세요.', '좋을게요.'],
        correct: '좋아해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['머리가', '머리를', '머리에서'],
        correct: '머리가',
      },
      {
        options: ['긴 사람이', '길은 사람이', '길는 사람이'],
        correct: '긴 사람이',
      },
      {
        options: ['제 언니예요.', '제 언니를요.', '제 언니에서요.'],
        correct: '제 언니예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['먼 편이에요.', '멀은 편이에요.', '멀는 편이에요.'],
        correct: '먼 편이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['서울에', '서울을', '서울에서를'],
        correct: '서울에',
      },
      {
        options: ['삽니다.', '살습니다.', '살ㅂ니다.'],
        correct: '삽니다.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['그 가게를', '그 가게가', '그 가게에서'],
        correct: '그 가게를',
      },
      {
        options: ['잘 압니다.', '잘 알습니다.', '잘 알ㅂ니다.'],
        correct: '잘 압니다.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이 옷은', '이 옷을', '이 옷에서'],
        correct: '이 옷은',
      },
      {
        options: ['어디에서', '어디를', '어디까지를'],
        correct: '어디에서',
      },
      {
        options: ['파세요?', '팔세요?', '팔으세요?'],
        correct: '파세요?',
      },
    ],
    {
...
const G18_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['작은 가방도', '작ㄴ 가방도', '작는 가방도'],
        correct: '작은 가방도',
      },
      {
        options: ['보여 주세요.', '먹어 주세요.', '가 주세요.'],
        correct: '보여 주세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['빨간 셔츠를', '빨갛은 셔츠를', '빨갛는 셔츠를'],
        correct: '빨간 셔츠를',
      },
      {
        options: ['입었어요.', '먹었어요.', '갔어요.'],
        correct: '입었어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['추운 날에는', '춥은 날에는', '춥는 날에는'],
        correct: '추운 날에는',
      },
      {
        options: ['따뜻한 옷을', '따뜻하는 옷을', '따뜻은 옷을'],
        correct: '따뜻한 옷을',
      },
      {
        options: ['입으세요.', '먹으세요.', '가세요.'],
        correct: '입으세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['여름에는', '여름을', '여름에서를'],
        correct: '여름에는',
      },
      {
        options: ['더운 날이', '덥은 날이', '덥는 날이'],
        correct: '더운 날이',
      },
      {
        options: ['많아요.', '먹어요.', '가요.'],
  ...
  ...build(
    ...
    [
      {
        options: ['편한 신발을', '편하는 신발을', '편은 신발을'],
        correct: '편한 신발을',
      },
      {
        options: ['신고 싶어요.', '먹고 싶어요.', '가고 싶어요.'],
        correct: '신고 싶어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['저기', '저기를', '저기에서를'],
        correct: '저기',
      },
      {
        options: ['키가 큰 사람이', '키가 크는 사람이', '키가 크은 사람이'],
        correct: '키가 큰 사람이',
      },
      {
        options: ['우리 형이에요.', '우리 형을이에요.', '우리 형에서예요.'],
        correct: '우리 형이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['깨끗한 셔츠를', '깨끗하는 셔츠를', '깨끗은 셔츠를'],
        correct: '깨끗한 셔츠를',
      },
      {
  ...
  ...build(
    ...
    [
      {
        options: ['생일 선물로', '생일 선물을', '생일 선물에서'],
        correct: '생일 선물로',
      },
      {
        options: ['좋은 가방을', '좋는 가방을', '좋ㄴ 가방을'],
        correct: '좋은 가방을',
      },
      {
        options: ['샀어요.', '먹었어요.', '갔어요.'],
        correct: '샀어요.',
      },
    ],
    {
...
const G19_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['친구한테', '친구로', '친구까지'],
        correct: '친구한테',
      },
      {
        options: ['생일 선물을', '생일 선물이', '생일 선물에'],
        correct: '생일 선물을',
      },
      {
        options: ['줬어요.', '갔어요.', '먹었어요.'],
        correct: '줬어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['친구한테', '친구로', '친구에서'],
        correct: '친구한테',
      },
      {
        options: ['전화했어요.', '먹었어요.', '읽었어요.'],
        correct: '전화했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['수진 씨한테', '수진 씨로', '수진 씨에서'],
        correct: '수진 씨한테',
      },
      {
        options: ['메시지를', '메시지가', '메시지에'],
        correct: '메시지를',
      },
      {
        options: ['보냈어요.', '먹었어요.', '갔어요.'],
        correct: '보냈어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['선생님께', '선생님한테만', '선생님으로'],
        correct: '선생님께',
      },
      {
        options: ['질문했어요.', '먹었어요.', '갔어요.'],
        correct: '질문했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['할머니께', '할머니로', '할머니에서'],
        correct: '할머니께',
      },
      {
        options: ['전화를 했어요.', '전화를 먹었어요.', '전화를 갔어요.'],
        correct: '전화를 했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['어떤 옷이 좋은지', '어떤 옷을 좋아서', '어떤 옷으로부터'],
        correct: '어떤 옷이 좋은지',
      },
      {
        options: ['물어봤어요.', '먹어봤어요.', '가봤어요.'],
        correct: '물어봤어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['선생님께', '선생님으로', '선생님에서'],
        correct: '선생님께',
      },
      {
        options: ['감사의 편지를', '감사의 편지가', '감사의 편지에를'],
        correct: '감사의 편지를',
      },
      {
        options: ['썼어요.', '먹었어요.', '갔어요.'],
        correct: '썼어요.',
      },
    ],
    {
...
const G20_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['이 신발도', '이 신발을도', '이 신발에서'],
        correct: '이 신발도',
      },
      {
        options: ['신어 보세요.', '신어 주세요.', '신지 마세요.'],
        correct: '신어 보세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이 모자를', '이 모자가', '이 모자에'],
        correct: '이 모자를',
      },
      {
        options: ['써 보세요.', '쓰어 보세요.', '쓰아 보세요.'],
        correct: '써 보세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이 노래를', '이 노래가', '이 노래에서'],
        correct: '이 노래를',
      },
      {
        options: ['들어 보세요.', '듣어 보세요.', '듣아 보세요.'],
        correct: '들어 보세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['시간이 있으면', '시간이 있어서만', '시간을 있으면'],
        correct: '시간이 있으면',
      },
      {
        options: ['제주도에', '제주도를', '제주도에서를'],
        correct: '제주도에',
      },
      {
        options: ['가 보세요.', '가 주세요.', '가지 마세요.'],
        correct: '가 보세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['사용해 보세요.', '사용하아 보세요.', '사용하어 보세요.'],
        correct: '사용해 보세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['어려우면', '어려워서만', '어려울까지'],
        correct: '어려우면',
      },
      {
        options: ['다른 방법으로', '다른 방법을', '다른 방법에서'],
        correct: '다른 방법으로',
      },
      {
        options: ['해 보세요.', '하아 보세요.', '하어 보세요.'],
        correct: '해 보세요.',
      },
    ],
    {
...
const G21_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['시간이 있으면', '시간이 있어서', '시간을 있으면'],
        correct: '시간이 있으면',
      },
      {
        options: ['여행을', '여행이', '여행에를'],
        correct: '여행을',
      },
      {
        options: ['가고 싶어요.', '가지 마세요.', '갔어요.'],
        correct: '가고 싶어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['한국에 가면', '한국에 가서', '한국에 갔어요'],
        correct: '한국에 가면',
      },
      {
        options: ['제주도에도', '제주도를만', '제주도에서를'],
        correct: '제주도에도',
      },
      {
        options: ['가고 싶어요.', '가지 마세요.', '갔어요.'],
  ...
  ...build(
    ...
    [
      {
        options: ['비가 오면', '비가 와서', '비를 오면'],
        correct: '비가 오면',
      },
      {
        options: ['박물관에', '박물관을', '박물관이가'],
        correct: '박물관에',
      },
      {
        options: ['갈 거예요.', '갔어요.', '가지 마세요.'],
        correct: '갈 거예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['배가 고프면', '배가 고파서만', '배를 고프면'],
        correct: '배가 고프면',
      },
      {
        options: ['이 식당에', '이 식당을', '이 식당이가'],
        correct: '이 식당에',
      },
      {
        options: ['가 보세요.', '가지 마세요.', '갔어요.'],
        correct: '가 보세요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['친구를 만나면', '친구를 만나서만', '친구가 만나면'],
        correct: '친구를 만나면',
      },
      {
        options: ['같이', '같이를', '같이에'],
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['기분이 좋아져요.', '기분을 먹어요.', '기분에 가요.'],
        correct: '기분이 좋아져요.',
      },
    ],
    {
...
const G22_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['가는 곳은', '간는 곳은', '가은 곳은'],
        correct: '가는 곳은',
      },
      {
        options: ['제주도예요.', '제주도를요.', '제주도에서요.'],
        correct: '제주도예요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['공부하는 사람이', '공부한는 사람이', '공부하은 사람이'],
        correct: '공부하는 사람이',
      },
      {
        options: ['많아요.', '먹어요.', '가요.'],
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['읽는 책은', '읽은는 책은', '읽으는 책은'],
        correct: '읽는 책은',
      },
      {
        options: ['여행 책이에요.', '여행 책을이에요.', '여행 책에서예요.'],
        correct: '여행 책이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['사는 곳은', '살는 곳은', '살은 곳은'],
        correct: '사는 곳은',
      },
      {
        options: ['서울이에요.', '서울을이에요.', '서울에서예요.'],
        correct: '서울이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['음식을', '음식이', '음식에서'],
        correct: '음식을',
      },
      {
        options: ['만드는 사람이', '만들는 사람이', '만들은 사람이'],
        correct: '만드는 사람이',
      },
      {
        options: ['제 형이에요.', '제 형을이에요.', '제 형에서예요.'],
        correct: '제 형이에요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['아는 사람도', '알는 사람도', '알은 사람도'],
        correct: '아는 사람도',
      },
      {
        options: ['한국에 살아요.', '한국을 먹어요.', '한국에서를 가요.'],
        correct: '한국에 살아요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['기다리는 버스가', '기다린는 버스가', '기다리은 버스가'],
        correct: '기다리는 버스가',
      },
      {
        options: ['곧 와요.', '곧 먹어요.', '곧 읽어요.'],
        correct: '곧 와요.',
      },
    ],
    {
...
const G23_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['한국에서', '한국을', '한국이가'],
        correct: '한국에서',
      },
      {
        options: ['여행하고 싶어요.', '여행해서 싶어요.', '여행하는 싶어요.'],
        correct: '여행하고 싶어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['한국 친구를', '한국 친구가', '한국 친구에게'],
        correct: '한국 친구를',
      },
      {
        options: ['만나고 싶어요.', '만나서 싶어요.', '만날 싶어요.'],
        correct: '만나고 싶어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['잘하고 싶어요.', '잘해서 싶어요.', '잘할 싶어요.'],
        correct: '잘하고 싶어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['나가고 싶지 않아요.', '나가지 마세요.', '나가고 있어요.'],
        correct: '나가고 싶지 않아요.',
      },
    ],
    {
...
const G24_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['가고 싶어 해요.', '가서 싶어 해요.', '갈고 싶어 해요.'],
        correct: '가고 싶어 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['입고 싶어 해요.', '입어고 싶어 해요.', '입을 싶어 해요.'],
        correct: '입고 싶어 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['아이들이', '아이들을', '아이들에게를'],
        correct: '아이들이',
      },
      {
        options: ['놀이공원에', '놀이공원을', '놀이공원에서를'],
        correct: '놀이공원에',
      },
      {
        options: ['가고 싶어 해요.', '가서 싶어 해요.', '갈 싶어 해요.'],
        correct: '가고 싶어 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['먹고 싶어 해요.', '먹어고 싶어 해요.', '먹을 싶어 해요.'],
        correct: '먹고 싶어 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['서울에서', '서울을', '서울이가'],
        correct: '서울에서',
      },
      {
        options: ['살고 싶어 해요.', '살아서 싶어 해요.', '살을 싶어 해요.'],
        correct: '살고 싶어 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['동생은', '동생을', '동생에게'],
        correct: '동생은',
      },
      {
        options: ['새 카메라를', '새 카메라가', '새 카메라에서'],
        correct: '새 카메라를',
      },
      {
        options: ['사고 싶어 해요.', '사서 싶어 해요.', '살 싶어 해요.'],
        correct: '사고 싶어 해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['쉬고 싶어 했어요.', '쉬고 싶어 해요.', '쉬어서 싶었어요.'],
        correct: '쉬고 싶어 했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['부모님은', '부모님을', '부모님에게'],
        correct: '부모님은',
      },
      {
        options: ['저하고 같이', '저를 같이', '저에서 같이'],
        correct: '저하고 같이',
      },
      {
        options: [
...
const G25_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['오늘 저녁에', '어제 저녁에', '지금까지'],
        correct: '오늘 저녁에',
      },
      {
        options: ['우리 집에', '우리 집을', '우리 집에서를'],
        correct: '우리 집에',
      },
      {
        options: ['올 수 있어요?', '오을 수 있어요?', '올 수 없어요?'],
        correct: '올 수 있어요?',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['말할 수 있어요.', '말하을 수 있어요.', '말해 수 있어요.'],
        correct: '말할 수 있어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['이 음식을', '이 음식이', '이 음식에'],
        correct: '이 음식을',
      },
      {
        options: ['먹을 수 있어요.', '먹으을 수 있어요.', '먹어 수 있어요.'],
        correct: '먹을 수 있어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['먹을 수 없어요.', '먹으을 수 없어요.', '먹을 수 있어요.'],
        correct: '먹을 수 없어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['자전거를', '자전거가', '자전거에서'],
        correct: '자전거를',
      },
      {
        options: ['탈 수 있어요.', '타을 수 있어요.', '타 수 있어요.'],
        correct: '탈 수 있어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['주말에는', '주말을', '주말에서를'],
        correct: '주말에는',
      },
      {
        options: ['늦게까지', '늦게부터', '늦게를'],
        correct: '늦게까지',
      },
      {
        options: [
...
const G26_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['음료수를', '음료수가', '음료수에'],
        correct: '음료수를',
      },
      {
        options: ['준비할게요.', '준비하을게요.', '준비할 거예요만.'],
        correct: '준비할게요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['집들이 선물은', '집들이 선물을', '집들이 선물에서'],
        correct: '집들이 선물은',
      },
      {
        options: ['제가', '저를', '저에게'],
...
const G27_Q = {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['만나러', '만나으러', '만날러'],
        correct: '만나러',
      },
      {
        options: ['카페에 가요.', '카페를 먹어요.', '카페에서를 와요.'],
        correct: '카페에 가요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['식당에 갔어요.', '식당을 먹었어요.', '식당에서를 왔어요.'],
        correct: '식당에 갔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['집들이 선물을', '집들이 선물이', '집들이 선물에'],
        correct: '집들이 선물을',
      },
      {
        options: ['사러', '사으러', '살러'],
      ...
      {
        options: ['백화점에 가요.', '백화점을 먹어요.', '백화점에서를 가요.'],
        correct: '백화점에 가요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['공부하러', '공부하으러', '공부할러'],
        correct: '공부하러',
      },
      {
        options: ['한국에 왔어요.', '한국을 왔어요.', '한국에서를 왔어요.'],
        correct: '한국에 왔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['도와주러 왔어요.', '도와주으러 왔어요.', '도와줄러 왔어요.'],
        correct: '도와주러 왔어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['잃어버린 가방을', '잃어버린 가방이', '잃어버린 가방에'],
        correct: '잃어버린 가방을',
      },
      {
        options: ['찾으러', '찾러', '찾을러'],
...
const G28_Q = {
  ...
  ...build(
    ...
    [
      {
        options: ['공원을', '공원이', '공원에만'],
        correct: '공원을',
      },
      {
        options: ['걸으면서', '걷으면서', '걸면서'],
        correct: '걸으면서',
      },
      {
        options: ['이야기해요.', '먹어요.', '읽어요.'],
        correct: '이야기해요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['보면서', '보으면서', '볼면서'],
        correct: '보면서',
      },
      {
        options: ['저녁을 먹었어요.', '저녁이 갔어요.', '저녁에서 읽었어요.'],
        correct: '저녁을 먹었어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['들으면서', '듣으면서', '들을면서'],
        correct: '들으면서',
      },
      {
        options: ['요리했어요.', '먹었어요만.', '갔어요만.'],
        correct: '요리했어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      ...
      {
        options: ['청소하면서', '청소하으면서', '청소할면서'],
        correct: '청소하면서',
      },
      {
        options: ['손님을 기다렸어요.', '손님이 먹었어요.', '손님을 갔어요.'],
        correct: '손님을 기다렸어요.',
      },
    ],
    {
  ...
  ...build(
    ...
    [
      {
        options: ['친구와', '친구를와', '친구에서'],
        correct: '친구와',
      },
      {
        options: ['이야기하면서', '이야기하으면서', '이야기할면서'],
        correct: '이야기하면서',
      },
      {
        options: ['음식을 만들었어요.', '음식이 갔어요.', '음식에서 읽었어요.'],
        correct: '음식을 만들었어요.',
      },
    ],
    {
