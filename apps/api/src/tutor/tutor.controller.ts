...
export class TutorController {
   ...
   */
  /**
   * 한국어 한 줄을 Azure ko-KR 목소리로 합성한다.
   *
   * ⚠️ **통화 음성이 아니다.** 실시간 대화 소리는 Gemini 가 직접 내고
   *    이 서버를 지나지 않는다. 여기는 **정확한 발음이 필요한 자리** 전용이다:
   *      · "오늘의 표현" 카드의 스피커 버튼
   *      · 예문 다시 듣기 / 천천히 듣기
   *      · 발음 연습, 선생님 목소리 미리듣기
   *    Gemini 목소리는 다국어라 한국어 발음이 ko-KR 전용 목소리만큼
   *    정확하지 않다. 따라 할 기준 발음은 이쪽을 쓴다.
   *
